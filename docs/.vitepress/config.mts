      ...
      '/CSS 权威指南/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '字重', link: '/CSS 权威指南/5 字体/5.3 字重.md' },
            { text: '字号', link: '/CSS 权威指南/5 字体/5.4 字号.md' },
            { text: '字形', link: '/CSS 权威指南/5 字体/5.5 字形.md' },
            { text: '字体拉伸', link: '/CSS 权威指南/5 字体/5.6 字体拉伸.md' },
            { text: '字距调整', link: '/CSS 权威指南/5 字体/5.7 字距调整.md' },
            { text: 'font 属性', link: '/CSS 权威指南/5 字体/5.8 font 属性.md' },
            { text: '小结', link: '/CSS 权威指南/5 字体/5.13 小结.md' }
          ]
        },
        {
          text: '文本属性',
          items: [
            { text: '文本属性', link: '/CSS 权威指南/6 文本属性/文本属性.md' },
            { text: '缩和合行内对齐', link: '/CSS 权威指南/6 文本属性/6.1 缩和合行内对齐.md' },
            { text: '块级对齐', link: '/CSS 权威指南/6 文本属性/6.2 块级对齐.md' },
            { text: '单词间距和字符间距', link: '/CSS 权威指南/6 文本属性/6.3 单词间距和字符间距.md' },
            { text: '文本转换', link: '/CSS 权威指南/6 文本属性/6.4 文本转换.md' },
            { text: '文本装饰', link: '/CSS 权威指南/6 文本属性/6.5 文本装饰.md' },
            { text: '文本阴影', link: '/CSS 权威指南/6 文本属性/6.7 文本阴影.md' },
            { text: '处理空白', link: '/CSS 权威指南/6 文本属性/6.8 处理空白.md' },
            { text: '换行和断字', link: '/CSS 权威指南/6 文本属性/6.9 换行和断字.md' },
            { text: '小结', link: '/CSS 权威指南/6 文本属性/6.11 小结.md' }
          ]
        },
        {
          text: '视觉格式化基础',
          items: [
            { text: '视觉格式化基础', link: '/CSS 权威指南/7 视觉格式化基础/视觉格式化基础.md' },
            { text: '元素框基础', link: '/CSS 权威指南/7 视觉格式化基础/7.1 元素框基础.md' },
            { text: '调整元素的显示方式', link: '/CSS 权威指南/7 视觉格式化基础/7.2 调整元素的显示方式.md' }
          ]
        },
        {
          text: '内边边框、轮廓和外边距',
          items: [
            { text: '基本元素框', link: '/CSS 权威指南/8 内边边框、轮廓和外边距/8.1 基本元素框.md' },
            { text: '内边距', link: '/CSS 权威指南/8 内边边框、轮廓和外边距/8.2 内边距.md' },
            { text: '边框', link: '/CSS 权威指南/8 内边边框、轮廓和外边距/8.3 边框.md' },
            { text: '轮廓', link: '/CSS 权威指南/8 内边边框、轮廓和外边距/8.4 轮廓.md' },
            { text: '外边距', link: '/CSS 权威指南/8 内边边框、轮廓和外边距/8.5 外边距.md' }
          ]
        },
        {
          text: '定位',
          items: [
            { text: '什么是定位', link: '/CSS 权威指南/11 定位/什么是定位.md' },
            { text: '基本概念', link: '/CSS 权威指南/11 定位/11.1 基本概念.md' },
            { text: '偏移属性', link: '/CSS 权威指南/11 定位/11.2 偏移属性.md' },
            { text: '宽度和高度', link: '/CSS 权威指南/11 定位/11.3 宽度和高度.md' },
            { text: '内容溢出和裁剪', link: '/CSS 权威指南/11 定位/11.4 内容溢出和裁剪.md' },
            { text: '元素的可见性', link: '/CSS 权威指南/11 定位/11.5 元素的可见性.md' },
            { text: '绝对定位', link: '/CSS 权威指南/11 定位/11.6 绝对定位.md' },
            { text: '固定定位', link: '/CSS 权威指南/11 定位/11.7 固定定位.md' },
            { text: '相对定位', link: '/CSS 权威指南/11 定位/11.8 相对定位.md' },
            { text: '粘滞定位', link: '/CSS 权威指南/11 定位/11.9 粘滞定位.md' },
            { text: '小节', link: '/CSS 权威指南/11 定位/11.10 小节.md' }
          ]
        },
        {
          text: '弹性盒布局',
          items: [
            { text: '弹性盒基础', link: '/CSS 权威指南/12 弹性盒布局/12.1 弹性盒基础.md' },
            { text: '弹性容器', link: '/CSS 权威指南/12 弹性盒布局/12.2 弹性容器.md' },
            { text: '调整内容', link: '/CSS 权威指南/12 弹性盒布局/12.5 调整内容.md' },
            { text: '对齐元素', link: '/CSS 权威指南/12 弹性盒布局/12.6 对齐元素.md' },
            { text: 'order 属性', link: '/CSS 权威指南/12 弹性盒布局/12.6 order属性.md' },
            { text: 'align-self 属性', link: '/CSS 权威指南/12 弹性盒布局/12.7 align-self属性.md' },
            { text: '对齐内容', link: '/CSS 权威指南/12 弹性盒布局/12.8 对齐内容.md' },
            { text: '弹性元素', link: '/CSS 权威指南/12 弹性盒布局/12.9 弹性元素.md' },
            { text: 'flex 属性', link: '/CSS 权威指南/12 弹性盒布局/12.11 flex属性.md' },
            { text: 'flex-basis 属性', link: '/CSS 权威指南/12 弹性盒布局/12.14 flex-basis属性.md' },
            { text: 'flex 简写属性', link: '/CSS 权威指南/12 弹性盒布局/12.15 flex简写属性.md' }
          ]
        },
        {
          text: '栅格布局',
          items: [
            { text: '创建栅格容器', link: '/CSS 权威指南/13 栅格布局/13.1 创建栅格容器.md' },
            { text: '基本的栅格术语', link: '/CSS 权威指南/13 栅格布局/13.2 基本的栅格术语.md' },
            { text: '放置栅格线', link: '/CSS 权威指南/13 栅格布局/13.3 放置栅格线.md' }
          ]
        },
        {
          text: '过渡',
          items: [
            { text: '什么是过渡', link: '/CSS 权威指南/17 过渡/17.1 什么是过渡.md' },
            { text: '定义过渡的属性', link: '/CSS 权威指南/17 过渡/17.2 定义过渡的属性.md' },
            { text: '反向过渡：退回起点', link: '/CSS 权威指南/17 过渡/17.3 反向过渡：退回起点.md' },
            { text: '支持动画的属性和值', link: '/CSS 权威指南/17 过渡/17.4 支持动画的属性和值.md' }
          ]
        },
        {
          text: '变形',
      ...
      'Vue.js 渐进式实现': [
        {
          ...
          },
          {
            ...
            items: [
              ...
              { text: '为 Set 和 Map 建立响应联系', link: '/Vue.js 渐进式实现/响应式系统/非原始值的响应式方案/14 为 Set 和 Map 建立响应联系.md'},
              { text: '避免污染原始数据', link: '/Vue.js 渐进式实现/响应式系统/非原始值的响应式方案/15 避免污染原始数据.md'},
            ]
          },
          {
            text: '原始值的响应式方案',
